      ...
      <>
        ...
        <Container id="food-main">
          <div className="food-leftside">
            ...
            <h2>Yamachan</h2>
            <div>
              <span className="food-star">5.0</span> (2 reviews){" "}
              <span className="food-cost">Free</span>
              <span className="food-place-type">Restaurants</span>
            </div>
            <hr></hr>
            <div className="food-description-hide" id="food-description-hide">
            ...
            <div className="food-description-show" id="food-description-show">
              <div className="inner-content">
